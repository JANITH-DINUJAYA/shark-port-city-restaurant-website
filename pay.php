...
// Get POSTed order data from payment page
$order_id = $_POST['order_id'] ?? 'ORDER-' . time();
$amount   = $_POST['amount'] ?? 0;
$currency = 'LKR'; // Adjusted to Sri Lankan Rupees
...
// Redirect URLs (change to your actual pages)
$return_url   = 'https://capitular-jocelynn-hamulate.ngrok-free.dev/Shark_port_city/feedback.html';
$cancel_url   = 'https://capitular-jocelynn-hamulate.ngrok-free.dev/Shark_port_city/payments.html';
$notify_url   = 'https://capitular-jocelynn-hamulate.ngrok-free.dev/Shark_port_city/payhere_notify.php';


// Get reservation details from session (if any)
$reservation = [
    'name'  => $_POST['name'] ?? 'Guest',
    'email' => $_POST['email'] ?? 'test@example.com',
    'phone' => $_POST['phone'] ?? '0771234567'
];
?>
<!DOCTYPE html>
<html>
...
<div class="payment-summary-container">
    ...
    <div class="summary-details">
        ...
        <div class="summary-item"><span>Phone:</span><span><?= htmlspecialchars($reservation['phone'] ?? '0771234567') ?></span></div>
        <div class="summary-item"><span>Order ID:</span><span><?= htmlspecialchars($order_id) ?></span></div>
    </div>

    <hr>

    <div class="payment-details">
        <div class="summary-item"><span>Amount (LKR):</span><span>Rs <?= number_format($amount, 2) ?></span></div>
        <div class="summary-item total-price"><span>Total:</span><span>Rs <?= number_format($amount, 2) ?></span></div>
    </div>
